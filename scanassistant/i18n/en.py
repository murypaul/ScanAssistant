...
STRINGS: dict[str, str] = {
    ...
    "menu.processing_toggle_orientation": "Toggle orientation",
    ...
    "capture.status_orientation": "Orientation: {orientation}",
    ...
    "wizard.step5.manual_group": "Manual mode settings (live, 07 §2 key P)",
    ...
    "wizard.step6.subtitle": "Written to every export (08_METADONNEES.md).",
