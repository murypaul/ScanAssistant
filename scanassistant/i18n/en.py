...
STRINGS: dict[str, str] = {
    ...
    "menu.project_positive_review": "Positive calibration…",
    ...
    "positive_review.unavailable": "Positive calibration is unavailable: no campaign is open.",
    "positive_review.apply_to_selection": "Apply to selection (Ctrl+Enter)",
    "positive_review.include_dmin": "Include Dmin",
    "positive_review.confirm_propagation_title": "Apply to selection",
    "positive_review.confirm_propagation_body": (
        "{count} image(s) will be regenerated with the current image's settings. Apply?"
    ),
    "positive_review.propagation_done": "Applied to {count} image(s).",
    ...
    "positive_calibration.group_exposure": "Scan exposure",
    ...
    "positive_calibration.advanced": "Advanced",
    "positive_calibration.paper_black": "Black point",
    "positive_calibration.paper_soft_clip": "Highlight soft-clip",
    ...
    "preferences.shortcut_pick_white_balance": "Pick white balance from a neutral point",
